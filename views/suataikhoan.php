                ...
                <div class="card-body">
                    <form action="index.php?act=suataikhoan" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="dia_chi" id="dia_chi" placeholder="Vui lòng điền địa chỉ của bạn" class="form-control" required><?php echo htmlspecialchars($tai_khoan['dia_chi'] ?? ''); ?></textarea>
                        </div>

                        <div class="form-group">
                            <label for="so_dien_thoai">Số điện thoại:</label>
                            <input type="text" name="so_dien_thoai" id="so_dien_thoai" placeholder="Vui lòng điền số điện thoại của bạn" class="form-control"
